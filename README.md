...
- 覆盖 11 只 A 股纳指 QDII ETF，以及香港 iShares 安硕 2834 作为参考。
...
| 列 | 含义 |
|---|---|
| 收盘溢价(±σ) | 按收盘价定投的累计溢价成本及波动 |
| 均价溢价(±σ) | 按 VWAP 定投的累计溢价成本及波动 |
| 加仓阈值 | 日内溢价25%分位均值，低于此值适合加仓 |
| 减仓阈值 | 日内溢价75%分位均值，高于此值应减仓 |
| 净值涨幅 | 末日净值 / 首日净值 - 1 |
| 场内涨幅 | 末日收盘价 / 首日收盘价 - 1 |
| 净值定投收益 | 末日净值 / 平均净值 - 1 |
| 收盘定投收益 | 末日收盘价 / 平均收盘价 - 1 |
